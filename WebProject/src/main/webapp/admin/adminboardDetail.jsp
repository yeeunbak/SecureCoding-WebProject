...
<%
    ...
    Boolean isWriterObj = (Boolean) request.getAttribute("isWriter");
    boolean isWriter = isWriterObj != null && isWriterObj;
...
<div class="board-container">
    ...
    <div class="btn-area">
        <input type="button" value="목록"
            onclick="location.href='<%= request.getContextPath() %>/admin/board/list'">

        <% if (isWriter) { %>
            <input type="button" value="수정"
                onclick="location.href='<%= request.getContextPath() %>/board/form?boardId=<%= boardId %>&returnUrl=admin'">
        <% } %>
