...
<script defer src="<%= request.getContextPath() %>/js/board/boardDetail.js"></script>
</head>
        ...
        <div class="comment-item">
            ...
            <% if (loginId.equals(comment.getWriterId())) { %>
                <div class="comment-btn-area">
                    <button type="button" class="comment-edit-toggle-btn" data-comment-id="<%= comment.getCommentId() %>">수정</button>
                    <form action="<%= request.getContextPath() %>/board/comment/delete" method="post" class="comment-delete-form">
                        <input type="hidden" name="boardId" value="<%= boardId %>">
                        <input type="hidden" name="commentId" value="<%= comment.getCommentId() %>">
                        <input type="submit" value="삭제" class="comment-delete-btn">
                    </form>
                </div>
                <div id="edit-form-<%= comment.getCommentId() %>" class="comment-edit-form hidden">
                    <form action="<%= request.getContextPath() %>/board/comment/update" method="post">
                        ...
                        <div class="btn-area">
                            ...
                            <button type="button" class="comment-edit-toggle-btn" data-comment-id="<%= comment.getCommentId() %>">취소</button>
                        </div>
                    </form>
                </div>
            <% } %>
...
<div class="btn-area">
    <input type="button" value="목록" class="move-btn" data-url="<%= request.getContextPath() %>/board/list">
    <% if (isWriter) { %>
        <input type="button" value="수정" class="move-btn" data-url="<%= request.getContextPath() %>/board/form?boardId=<%= boardId %>">
        <form action="<%= request.getContextPath() %>/board/delete" method="post" class="board-delete-form inline-form">
            <input type="hidden" name="boardId" value="<%= boardId %>">
